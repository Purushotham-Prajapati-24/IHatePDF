...
export const ToolWorkspace: React.FC = () => {
  ...
  const validTools: ToolType[] = ['merge', 'split', 'compress', 'rotate', 'ocr', 'organize', 'protect', 'unlock', 'repair', 'addPageNumbers', 'addWatermark', 'crop', 'edit', 'forms', 'jpgToPdf', 'wordToPdf', 'powerPointToPdf', 'excelToPdf', 'htmlToPdf', 'pdfToJpg', 'pdfToWord'];
